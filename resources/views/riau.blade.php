        ...
        <nav class="navbar navbar-expand-sm bg-primary navbar-dark fixed-top">
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <div class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ url('/riau') }}">Riau Finance</a>
                    </li>
                    <li class="nav-item">
    ...
    <main>
        <div class="container">
            <div class="jumbotron" style="margin-top:5em">
                <h1>Skema Kredit Riau Finance</h1>
            </div>
            <table class="table table-striped table-bordered table-hover">
                <tbody>
                    ...
                    <tr>
                        <td>Uang Muka</td>
                        <td>{{'Rp ' . number_format($motor["Harga"]*0.25, 0, '.', ',')}}</td>
                    </tr>
                    <tr>
                        <td>Bunga/Tahun</td>
                        <td>12%</td>
            ...
            <div class="mt-3">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                        $angsurandata = [[]];
                        $plafon = ($motor["Harga"] - ($motor["Harga"] * 0.25));
                        $angsuran = $plafon / 24;
